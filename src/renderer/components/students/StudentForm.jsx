...
import {
  ...
  listStudentPayments,
} from "../../services/student-payment.api";
...
function StudentForm({
  ...
  useEffect(() => {
    ...
    async function loadPaymentSummary() {
      ...
      try {
        ...
        console.error("[StudentForm] Failed to load payment summary:", error);
  ...
  useEffect(() => {
    ...
    async function loadPaymentHistory() {
      ...
      try {
        ...
        console.error("[StudentForm] Failed to load payment history:", error);
  ...
  function validate() {
    ...
    if (!isEditing) {
      ...
      if (
        ...
        nextErrors.registrationPayment = "Registration payment is required.";
      } else if (
        Number.isFinite(registrationFee) &&
      ...
      const courseTotal =
        Number(form.agreedFee || 0) - Number(form.discount || 0);

      if (!Number.isFinite(coursePayment) || coursePayment < 0) {
        nextErrors.coursePayment = "Course payment cannot be negative.";
  ...
  const handleRecordCoursePayment = async () => {
    ...
    try {
      ...
      console.error("[StudentForm] Failed to record course payment:", error);

      setServerError(error?.message || "Failed to record course payment.");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const result = await createAdmission({
        ...
        registrationFeeMinor: Math.round(Number(form.registrationFee) * 100),

        registrationPaymentMinor: Math.round(
          Number(form.registrationPayment) * 100,
        ),
        ...
        coursePaymentMethod:
          form.coursePayment > 0 ? form.coursePaymentMethod : null,
      });
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              disabled={submitting}
              className={errors.gender ? ERROR_INPUT_CLASS : INPUT_CLASS}
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              disabled={submitting}
              placeholder="e.g. CNIC / B-Form number"
              autoComplete="off"
              className={
                errors.identityNumber ? ERROR_INPUT_CLASS : INPUT_CLASS
              }
            />

            {renderFieldError("identityNumber")}
          </div>
        </div>
      </section>
    ...
    ========================================================= */}
      <section className="rounded-xl border border-slate-200 bg-white p-5">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Configure fees, record payments, and review the student's payment
            balance.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className={
                  errors.registrationFee ? ERROR_INPUT_CLASS : INPUT_CLASS
                }
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. 1000"
                className={
                  errors.registrationPayment ? ERROR_INPUT_CLASS : INPUT_CLASS
                }
              />
        ...
        <div>
          <div className="mb-3">
            ...
            <p className="mt-1 text-xs text-slate-400">
              Add a new course payment. Previous payments remain in the payment
              history.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className={
                  errors.coursePayment ? ERROR_INPUT_CLASS : INPUT_CLASS
                }
              />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-lg bg-slate-50 px-4 py-3">
              <p className="text-xs text-slate-500">Registration Paid</p>
            ...
            <div className="rounded-lg bg-slate-50 px-4 py-3">
              <p className="text-xs text-slate-500">Registration Remaining</p>
            ...
            {/* Course Remaining */}
            <div className="rounded-lg bg-slate-50 px-4 py-3">
              <p className="text-xs text-slate-500">Course Remaining</p>
